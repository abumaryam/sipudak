...
class Pengaduan_model extends CI_Model
{
    ...
    {
        $query = $this->db->select('nama_kecamatan, id_kecamatan')
            ->from('kecamatan')
            ->get()->result_array();
        return $query;
    }

    // public function get_data_desa($idkecamatan)
    // {
    //     return $this->db->get_where('desa', ['id_kecamatan' => $idkecamatan])result()
    // }
