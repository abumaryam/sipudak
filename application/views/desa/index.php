<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <!--end::Info-->
            <!--begin::Toolbar-->
            <a href="<?= site_url('desa/adddesa') ?>" class="btn btn-icon" data-toggle="popover" aria-haspopup="true" aria-expanded="false" data-content="Tambah">
                            ...
                            <tbody>
                                ...
                                foreach ($desa as $des) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            <div><?= $des['kecamatan'];  ?></div>
                                        </td>
                                        <td>
                                            <div><?= $des['j_kasus'];  ?></div>
                                        </td>
                                        <td>
                                            <div><?= $des['tahun_pengaduan'];  ?></div>
                                        </td>
                                        <td>
                                            <div><?= $des['long'];  ?></div>
                                        </td>
                                        ...
                                        <td class="py-0 ">
                                            <a href="<?= site_url('desa/editdesa/') ?><?= $des['id_desa'] ?>" class="btn btn-sm btn-light" data-container="body" data-toggle="popover" data-placement="top" data-content="edit">
                                                <i class="fas fa-pen-square text-info"></i>
                                            </a>
                                            <a href="<?= site_url('desa/delete/') ?><?= $des['id_desa'] ?>" class="btn btn-sm btn-light tombol-hapus" data-container="body" data-toggle="popover" data-placement="top" data-content="delete">
