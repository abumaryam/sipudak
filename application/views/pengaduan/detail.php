<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <!--end::Info-->
            <!--begin::Toolbar-->
            <a href="<?= site_url('pengaduan') ?>" class="btn btn-sm btn-secondary mr-2" data-container="body" data-toggle="popover" data-placement="left" data-content="Kembali">Kembali
            </a>
            <!--end::Toolbar-->
        </div>
    </div>
                    ...
                    <form class="form" id="kt_form">
                        <div class="tab-content">
                                    ...
                                    <div class="col-xl-6 my-5">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">Nomor
                                                Registrasi</label>
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid" type="text" value="<?= $pengaduan_kasus['no_registrasi'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">Tanggal
                                                Pengaduan</label>
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid" type="text" value="<?= $pengaduan_kasus['tanggal_pengaduan'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">Cara
                                                Datang</label>
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid" type="text" value="<?= $pengaduan_kasus['cara_datang'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">Nama
                                                Pelapor</label>
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid" type="text" value="<?= $pengaduan_kasus['nama'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">Kategori
                                                Kekerasan</label>
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid" type="text" value="<?= $pengaduan_kasus['kategori_kekerasan'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">Bentuk
                                                Kekerasan</label>
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid" type="text" value="<?= $pengaduan_kasus['jenis_kekerasan'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">Sub Bentuk
                                                Kekerasan</label>
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid" type="text" value="<?= $pengaduan_kasus['sub_jenis_kekerasan'] ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-xl-6 my-2">
                                        ...
                                        <div class="form-group row my-3">
                                            <label class="col-form-label col-3 text-lg-right text-left">Waktu
                                                Kejadian</label>
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid" type="text" value="<?= tgl_indonesia($pengaduan_kasus['waktu_kejadian']); ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">Tempat
                                                Kejadian</label>
                                            <div class="col-9">
                                                <input class="form-control form-control-lg form-control-solid" type="text" value="<?= $pengaduan_kasus['tempat_kejadian'] ?>">
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <label class="col-form-label col-3 text-lg-right text-left">Kronologis
                                                Kejadian</label>
                                            <div class="col-9">
                                                <textarea class="form-control form-control-lg form-control-solid" type="text" rows="3" value=""><?= $pengaduan_kasus['kronologis_kejadian'] ?></textarea>
                                            </div>
                                        </div>
                            ...
                            <div class="tab-pane px-0" id="kt_user_edit_tab_2" role="tabpanel">
                                <?php if (empty($korban)) : ?>
                                    <div class="px-4 py-5 my-5 text-center">
                                        <img class="d-block mx-auto mb-4" src="<?= base_url() ?>assets/media/svg/avatars/011-boy-5.svg" alt="" width="72" height="57">
                                        <div class="col-lg-12 mx-auto">
                                            <p class="lead mb-4">Data Korban belum ada silahkan isi data korban
                                                untuk melengkapi data pengaduan</p>
                                            <?php if ($user['role'] == 'Admin') : ?>
                                                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                                                    <a href="<?= site_url('pengaduan/addkorban/') ?><?= $laporan_kasus['id_pengaduan'] ?>" class="btn btn-primary btn-sm px-4 gap-3">Tambah data
                                                        korban</a>
                                                </div>
                                            <?php endif; ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    <td>
                                                        ...
                                                        <div><?= $kbn['jumlah_saudara'];  ?></div>
                                                            ...
                                                            <?php if ($user['role'] == 'Admin') : ?>
                                                                <td class="py-0 ">
                                                                    <a href="<?= site_url('pengaduan/editkorban/') ?><?= $kbn['id_korban'] ?>" class="btn btn-sm btn-icon btn-info mr-1" data-container="body" data-toggle="popover" data-placement="top" data-content="edit">
                                                                        <i class="fas fa-pen-square"></i>
                                                                    </a>
                                                                    <a href="<?= site_url('pengaduan/deletekorban/') ?><?= $kbn['id_korban'] ?>" class="btn btn-sm btn-icon btn-danger tombol-hapus" data-container="body" data-toggle="popover" data-placement="top" data-content="hapus">
                            ...
                            <div class="tab-pane px-0" id="kt_user_edit_tab_3" role="tabpanel">
                                <?php if (empty($pelaku)) : ?>
                                    <div class="px-4 py-5 my-5 text-center">
                                        <img class="d-block mx-auto mb-4" src="<?= base_url() ?>assets/media/svg/avatars/001-boy.svg" alt="" width="72" height="57">
                                        ...
                                        <div class="col-lg-12 mx-auto">
                                            ...
                                            <?php if ($user['role'] == 'Admin') : ?>
                                                <div class="d-grid gap-2 d-sm-flex justify-content-sm-center">
                                                    <a href="<?= site_url('pengaduan/addpelaku/') ?><?= $laporan_kasus['id_pengaduan'] ?>" class="btn btn-primary btn-sm px-4 gap-3">Tambah data
                                                        pelaku</a>
                                                </div>
                                            <?php endif; ?>
                                ...
                                <?php else : ?>
                                    <?php if ($user['role'] == 'Admin') : ?>
                                        <div class="py-5 px-10">
                                            <a href="<?= site_url('pengaduan/addpelaku/') ?><?= $laporan_kasus['id_pengaduan'] ?>" class="btn btn-primary btn-sm px-4 gap-3">Tambah data pelaku</a>
                                        </div>
                                    <?php endif; ?>
                                                ...
                                                <tbody>
                                                    ...
                                                    <td>
                                                        ...
                                                        <td>
                                                            ...
                                                            <?php if ($user['role'] == 'Admin') : ?>
                                                                <td class="px-0 ">
                                                                    <a href="<?= site_url('pengaduan/editpelaku/') ?><?= $plk['id_pelaku'] ?>" class="btn btn-sm btn-icon btn-info" data-container="body" data-toggle="popover" data-placement="top" data-content="edit">
                                                                        <i class="fas fa-pen-square"></i>
                                                                    </a>
                                                                    <a href="<?= site_url('pengaduan/deletepelaku/') ?><?= $plk['id_pelaku'] ?>" class="btn btn-sm btn-icon btn-danger tombol-hapus" data-container="body" data-toggle="popover" data-placement="top" data-content="hapus">
                                                                        <i class="far fa-trash-alt"></i>
                                                                    </a>
                                                                </td>
                                                            <?php endif; ?>
