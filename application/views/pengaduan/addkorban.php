    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Halaman Tambah korban</h5>
                <!--end::Page Title-->
                <!--begin::Actions-->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card card-custom gutter-b example example-compact">
                        <div class="card-header">
                            <h3 class="card-title">Tambah Korban</h3>
                        ...
                        <form class="form" method="post" action="">
                            <div class="card-body">
                                <div class="form-group row">
                                    <input type="text" class="form-control" placeholder="" name="id_pengaduan" value="<?= $laporan_kasus['id_pengaduan'] ?>" hidden>
                                    <div class="col-lg-4">
                                        <label>NIK:</label>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="" name="tempat_lahir" value="<?= set_value('tempat_lahir'); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-control" name="jenis_kelamin" id="cform-control form-control-solid form-control-lg">
                                    ...
                                    <div class="col-lg-4">
                                        <label>Alamat:</label>
                                        <input type="text" class="form-control" placeholder="" name="alamat" value="<?= set_value('alamat'); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        <label>Agama:</label>
                                        <select class="form-control" name="agama" id="cform-control form-control-solid form-control-lg">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-control" name="status_perkawinan" id="cform-control form-control-solid form-control-lg">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-control" name="pendidikan_terakhir" id="cform-control form-control-solid form-control-lg">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="pekerjaan" placeholder="" value="<?= set_value('pekerjaan'); ?>" />
                                        </div>
                            ...
                            <div class="card-footer">
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 text-lg-right">
                                        <a href="<?= site_url('pengaduan/detail/') ?><?= $laporan_kasus["id_pengaduan"] ?>" class="btn btn-secondary mr-2">Kembali</a>
