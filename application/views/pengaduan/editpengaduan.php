                            ...
                            <div class="card-body">
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" placeholder="" name="no_registrasi" value="<?= $pengaduan_kasus['no_registrasi'] ?>">
                                        <?= form_error('no_registrasi', '<div class="fv-plugins-message-container"><div class="fv-help-block">', '</div></div>') ?>
                                    </div>
                                    <div class="col-lg-4">
                                        <label>Hari/Tanggal:</label>
                                        <input type="date" class="form-control" name="tanggal_pengaduan" value="<?= $pengaduan_kasus['tanggal_pengaduan'] ?>">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="cara_datang" placeholder="" value="<?= $pengaduan_kasus['cara_datang'] ?>" />
                                        </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" name="korban_kekerasan" value="<?= $pengaduan_kasus['korban_kekerasan'] ?>">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-control" name="kategori_kekerasan" id="cform-control form-control-solid form-control-lg">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-control select2" id="kt_select2_1" name="id_sub_bentuk_kekerasan">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" name="alamat_kejadian" value="<?= $pengaduan_kasus['alamat_kejadian'] ?>">
                                        <?= form_error('alamat_kejadian', '<div class="fv-plugins-message-container"><div class="fv-help-block">', '</div></div>') ?>
                                        <!-- <span class="form-text text-muted">Please enter your contact number</span> -->
                                    </div>
                                    <div class="col-lg-4">
                                        <label>Waktu Kejadian:</label>
                                        <input type="text" class="form-control" name="waktu_kejadian" value="<?= date($pengaduan_kasus['waktu_kejadian']) ?>">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control" name="tempat_kejadian" placeholder="" value="<?= $pengaduan_kasus['tempat_kejadian'] ?>" />
                                        </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" name="hubungan_dengan_korban" value="<?= $pengaduan_kasus['hubungan_dengan_korban'] ?>" placeholder="" />
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <input type="text" class="form-control" name="tahun_pengaduan" value="<?= $pengaduan_kasus['tahun_pengaduan'] ?>" placeholder="" />
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        <label>Desa:</label>
                                        <select class="form-control" id="id_desa" name="nama_desa">
                                    ...
                                    <div class="col-lg-4">
                                        <label>Pelapor:</label>
                                        <input type="text" class="form-control" placeholder="" name="nama" value="<?= $pengaduan_kasus['nama'] ?>" disabled>
                                        <?= form_error('nama', '<div class="fv-plugins-message-container"><div class="fv-help-block">', '</div></div>') ?>
                                        <!-- <span class="form-text text-muted">Please enter your contact number</span> -->
                                    </div>
                                    <div class="col-lg-4">
                                        <label>Alamat Pelapor:</label>
                                        <input type="text" class="form-control" placeholder="" name="alamat_pelapor" value="<?= $pengaduan_kasus['alamat_pelapor'] ?>">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-4">
                                        ...
                                        <textarea type="text" class="form-control" name="kronologis_kejadian" placeholder=""><?= $pengaduan_kasus['kronologis_kejadian'] ?></textarea>
