                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" placeholder="" name="nama" value="<?= $pelaporan['nama'] ?>" disabled>
                                    <?= form_error('nama', '<div class="fv-plugins-message-container"><div class="fv-help-block">', '</div></div>') ?>
                                </div>
                                <div class="col-lg-6">
                                    <label>Nomor Hp:</label>
                                    <input type="text" class="form-control" name="no_hp" value="<?= $pelaporan['no_hp'] ?>">
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="input-group">
                                        <input type="text" name="alamat_pelapor" class="form-control" value="<?= $pelaporan['alamat_pelapor'] ?>" placeholder="Enter your address" />
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="date" name="tanggal_pelaporan" class="form-control" value="<?php echo date('Y-m-d', strtotime($pelaporan['tanggal_pelaporan'])); ?>" />
                                    <!-- <span class="form-text text-muted">Please enter your contact number</span> -->
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" name="tempat_kejadian" class="form-control" value="<?= $pelaporan['tempat_kejadian'] ?>" placeholder="" />
                                    <!-- <span class="form-text text-muted">Please enter your contact number</span> -->
                                </div>
                            </div>
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" name="alamat_kejadian" class="form-control" value="<?= $pelaporan['alamat_kejadian'] ?>" placeholder="" />
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <input type="text" class="form-control" name="hubungan_dengan_korban" value="<?= $pelaporan['hubungan_dengan_korban'] ?>" placeholder="" />
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <textarea type="text" name="kronologis_kejadian" class="form-control" placeholder=""><?= $pelaporan['kronologis_kejadian'] ?></textarea>
                                    <!-- <span class="form-text text-muted">Please enter your full name</span> -->
                                </div>
                            ...
                            <div class="form-group row">
                                <div class="col-lg-6">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            <img src="<?= base_url(); ?>assets/images/korban/<?= $pelaporan['image'] ?>" class="img-thumbnail" style="margin-bottom: 3;">
                                        </div>
                                        <div class="col-9 pt-15">
                                            <input type="file" class="form-control" name="image" value="<?= $pelaporan['image'] ?>" placeholder="upload foto" />
