                        ...
                        <div class="card-body pt-4">
                            ...
                            <div class="d-flex align-items-center">
                                <div class="symbol symbol-60 symbol-xxl-100 mr-5 align-self-start align-self-xxl-center">
                                    <div class="symbol-label" style="background-image: url(<?= base_url() ?>assets/images/users/<?= $row['image'] ?>">
                                    </div>
                                    <i class="symbol-badge bg-success"></i>
                                </div>
                                <div>
                                    <a href="" class="font-weight-bolder font-size-h5 text-dark-75 text-hover-primary"><?= $row['nama'] ?></a>
                            ...
                            <div class="navi navi-bold navi-hover navi-active navi-link-rounded">
                                ...
                                <div class="navi-item mb-2">
                                    <a href="/metronic/demo1/custom/apps/profile/profile-1/personal-information.html" class="navi-link py-4 active">
                                        <span class="navi-icon mr-2">
                                            <span class="svg-icon">
                    ...
                    <div class="card card-custom card-stretch">
                        ...
                        <div class="card-header py-3">
                            ...
                            <div class="card-toolbar">
                                ...
                                <a href="<?= base_url('user') ?>" class="btn btn-secondary font-weight-bold mr-2">Kembali</a>
                        ...
                        <form class="form">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <input disabled class="form-control form-control-lg form-control-solid" type="text" value="<?= $row['nama'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label">Alamat</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <input disabled class="form-control form-control-lg form-control-solid" type="text" value="<?= $row['alamat'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label">Role</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <input disabled class="form-control form-control-lg form-control-solid" type="text" value="<?= $row['role'] ?>">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="col-xl-3 col-lg-3 col-form-label">Is Active</label>
                                    <div class="col-lg-9 col-xl-6">
                                        <input disabled class="form-control form-control-lg form-control-solid" type="text" value="<?= $row['is_active'] ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="input-group input-group-lg input-group-solid">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid" value="<?= $row['no_hp'] ?>">
                                        </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-9 col-xl-6">
                                        <div class="input-group input-group-lg input-group-solid">
                                            ...
                                            <input type="text" class="form-control form-control-lg form-control-solid" value="<?= $row['email'] ?>">
                                        </div>
                                    </div>
                                </div>
